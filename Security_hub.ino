...
const char* mqtt_server = "192.168.20.237"; 
...
void setup_wifi() {
  delay(10);
  printSeparator('=');
  Serial.println("  Smart Home Threat Simulation Hub  |  Booting...");
  printSeparator('=');
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (strcmp(status, "SAFE") == 0 && doc["intelligent_masking"] == true) {
    ...
    Serial.print("[SPOOF] Masking packet #"); Serial.print(spoof_count); Serial.println(" intercepted!");
  }
