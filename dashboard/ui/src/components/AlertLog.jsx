...
const AlertLog = ({ alerts }) => {
  return (
    <div className="bg-slate-800 p-4 rounded-xl shadow-lg border border-slate-700 h-full flex flex-col">
      <h2 className="text-xl font-bold mb-4 text-rose-400 flex items-center shrink-0">
